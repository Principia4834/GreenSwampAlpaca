...
namespace GreenSwamp.Alpaca.Shared
{
    ...
    public class CommandQueueStatistics
    {
        ...
        /// </summary>
        public void IncrementTotalProcessed() => Interlocked.Increment(ref _totalCommandsProcessed);

        /// <summary>
        /// Increments the successful commands counter.
        /// </summary>
        public void IncrementSuccessful() => Interlocked.Increment(ref _commandsSuccessful);

        /// <summary>
        /// Increments the failed commands counter.
        /// </summary>
        public void IncrementFailed() => Interlocked.Increment(ref _commandsFailed);

        /// <summary>
        /// Increments the timed out commands counter.
        /// </summary>
        public void IncrementTimedOut() => Interlocked.Increment(ref _commandsTimedOut);

        /// <summary>
        /// Increments the exceptions handled counter.
        /// </summary>
        public void IncrementExceptions() => Interlocked.Increment(ref _exceptionsHandled);

        /// <summary>
        /// Returns a pipe-delimited summary of all statistics.
        /// </summary>
        public override string ToString() =>
            $"Total:{TotalCommandsProcessed}|Success:{CommandsSuccessful}|Failed:{CommandsFailed}|TimedOut:{CommandsTimedOut}|Exceptions:{ExceptionsHandled}";
    }
}
