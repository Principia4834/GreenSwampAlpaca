...
- Prefer strictly evidence-based analysis and do not make speculative assertions without direct support from code/logs. Provide corrective observations (e.g., exact line numbers from downloaded CSS) that should be treated as authoritative during debugging.
