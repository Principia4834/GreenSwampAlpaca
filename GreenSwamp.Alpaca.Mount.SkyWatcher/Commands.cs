...
namespace GreenSwamp.Alpaca.Mount.SkyWatcher
{
    ...
    public class Commands
    {
        ...
        {
            MountConnected = true;
            GetAxisVersion(Axis.Axis1);
            GetAxisVersion(Axis.Axis2);
            //calculate resolution needed
            GetResolutionFactors();
            // Inquire Gear Rate
            GetStepsPerRevolution(Axis.Axis1);
            GetStepsPerRevolution(Axis.Axis2);
            // Inquire motor high speed ratio
            GetTimerInterruptFreq(Axis.Axis1);
            GetTimerInterruptFreq(Axis.Axis2);
            // Inquire motor high speed ratio
            GetHighSpeedRatio(Axis.Axis1);
            GetHighSpeedRatio(Axis.Axis2);
            //
            InitializeAxes();
            // Inquire Axis Position
            GetStartupPosition(Axis.Axis1);
            GetStartupPosition(Axis.Axis2);
            // encoders
            LogEncoderCount(Axis.Axis1);
            LogEncoderCount(Axis.Axis2);
            // These two LowSpeedGotoMargin are calculate from slewing for 5 seconds in 128x sidereal rate
            _lowSpeedGotoMargin[(int)Axis.Axis1] = (long)(640 * Constant.SiderealRate * _factorRadToStep[(int)Axis.Axis1]);
            _lowSpeedGotoMargin[(int)Axis.Axis2] = (long)(640 * Constant.SiderealRate * _factorRadToStep[(int)Axis.Axis2]);
            // Default break steps
            _breakSteps[(int)Axis.Axis1] = 3500;
            _breakSteps[(int)Axis.Axis2] = 3500;
        }
        ...
        private void GetResolutionFactors()
        {
            ...
            {
                // New
                response = CmdToMount(Axis.Axis1, 'X', "0002");
            ...
            // Old
            response = CmdToMount(Axis.Axis1, 'a', null);
        ...
        private void GetStepsPerRevolution(Axis axis)
        {
            string response, msg;
            if (SupportAdvancedCommandSet && AllowAdvancedCommandSet)
            {
        ...
        /// </summary>
        /// <param name="axis">Axis.Axis1 or Axis.Axis2</param>
        private void GetTimerInterruptFreq(Axis axis)
        {
        ...
        /// </summary>
        /// <param name="axis">Axis.Axis1 or Axis.Axis2</param>
        private void LogEncoderCount(Axis axis)
        {
            var response = CmdToMount(axis, 'd', null);
            var responseString = StringToLong(response);
            var monitorItem = new MonitorEntry
        ...
        /// </summary>
        /// <param name="axis">Axis.Axis1 or Axis.Axis2</param>
        internal void GetAxisVersion(Axis axis)
        {
        ...
        /// </summary>
        /// <param name="axis">Axis.Axis1 or Axis.Axis2</param>
        private void GetHighSpeedRatio(Axis axis)
        {
        ...
        internal long GetLastSlewSpeed(Axis axis, bool oldI = true)
        {
            string response;
            long iSpeed;
        ...
        /// <param name="axis">Axis.Axis1 or Axis.Axis2</param>
        /// <returns>Radians of the axis</returns>
        private void GetStartupPosition(Axis axis)
        {
            try
            {
                long iPosition;
        ...
        internal double GetAxisPositionNaN(Axis axis)
        {
            if (SupportAdvancedCommandSet && AllowAdvancedCommandSet)
            {
        ...
        internal double GetAxisStepsNaN(Axis axis)
        {
            try
            {
                if (SupportAdvancedCommandSet && AllowAdvancedCommandSet)
        ...
        /// </summary>
        /// <param name="axis">Axis.Axis1 or Axis.Axis2</param>  
        internal string GetCapabilities(Axis axis)
        {
        ...
        internal void SetAxisPosition(Axis axis, double radians)
        {
        ...
        internal void SetAxisPositionCounter(Axis axis, int steps)
        {
            if (SupportAdvancedCommandSet && AllowAdvancedCommandSet)
            {
        ...
        internal void InitializeAxes()
        {
            ...
            if (_axesStatus[0].Initialized == false)
            {
                if (SupportAdvancedCommandSet && AllowAdvancedCommandSet)
                {
                    CmdToMount(Axis.Axis1, 'X', "0505");
                    msg = "X10505|Axis1";
                }
                else
                {
                    CmdToMount(Axis.Axis1, 'F', null);
                    msg = ":F|Axis1";
                }
                monitorItem = new MonitorEntry
            ...
            if (_axesStatus[1].Initialized == false)
            {
                if (SupportAdvancedCommandSet && AllowAdvancedCommandSet)
                {
                    CmdToMount(Axis.Axis2, 'X', "0505");
                    msg = "X20505|Axis2";
                }
                else
                {
                    CmdToMount(Axis.Axis2, 'F', null);
                    msg = ":F|Axis2";
                }
                monitorItem = new MonitorEntry
                { Datetime = HiResDateTime.UtcNow, Device = MonitorDevice.Telescope, Category = MonitorCategory.Mount, Type = MonitorType.Information, Method = MethodBase.GetCurrentMethod()?.Name, Thread = Environment.CurrentManagedThreadId, Message = $"Initialized|" + msg };
        ...
        internal void SetMotionMode(Axis axis, int func, int direction, bool southernHemisphere)
        {
            switch (direction)
            {
                case 0:
        ...
        /// <param name="axis"></param>
        /// <param name="on"></param>
        internal string SetSnapPort(Axis axis, bool on)
        {
            string response;
            if (SupportAdvancedCommandSet && AllowAdvancedCommandSet)
            {
        ...
        internal void SetBreakSteps(Axis axis, long newBrakeSteps)
        {
        ...
        /// <param name="axis">Axis.Axis1 or Axis.Axis2</param>
        /// <param name="on"></param>
        internal void SetEncoders(Axis axis, bool on)
        {
        ...
        /// <param name="axis">Axis.Axis1 or Axis.Axis2</param>
        /// <param name="on"></param>
        internal void SetLowSpeedCurrent(Axis axis, bool on)
        {
        ...
        /// </summary>
        /// <param name="axis">Axis.Axis1 or Axis.Axis2</param>
        internal void SetSlewingStride(Axis axis)
        {
        ...
        internal void AxisSlew_Advanced(Axis axis, double rateInRadian)
        {
            var ratePad = '0';
                    ...
                    if (acquiredLock)
                    {
                        ...
                        try
                        {
                            ...
                            if (string.IsNullOrEmpty(responseString))
                            {
                                ...
                                SendRequest(Axis.Axis1, 'K', null);
                                SendRequest(Axis.Axis2, 'K', null);
                        ...
                        catch (TimeoutException ex)
                        {
                            ...
                            throw new MountControlException(axis == Axis.Axis1 ? ErrorCode.ErrNoResponseAxis1 : ErrorCode.ErrNoResponseAxis2, "Timeout", ex);
                        }
        ...
        private string SendRequest(Axis axis, char command, string cmdDataStr)
        {
            ...
            // Target Device
            commandStr.Append(axis == Axis.Axis1 ? '1' : '2');// 2: Target Axis
            ...
            switch (command)
            {
                ...
                case 'j' when axis == Axis.Axis1:
                    LastJ1RunTime = dt;
                    break;
                case 'j' when axis == Axis.Axis2:
                    LastJ2ARunTime = dt;
                    break;
                case 'J' when axis == Axis.Axis2:
                    LastJ2RunTime = dt;
                    break;
                case 'I' when axis == Axis.Axis1:
                    LastI1RunTime = dt;
                    break;
                case 'X':
                    if (cmdDataStr == "0003")
        ...
        /// <returns></returns>
        internal double StepToAngle(Axis axis, long steps)
        {
        ...
        /// <returns></returns>
        public int AngleToStep(Axis axis, double angleInRad)
        {
        ...
        private static int String32ToInt(string response, bool parseFirst, int divFactor)
        {
            ...
            catch (Exception ex)
            {
                ...
                // DeviceNumber intentionally 0 — static utility method has no instance device context
